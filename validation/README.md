...
- `tla/ProfileLifecycle.tla` checks the cross-authority profile lifecycle. A
  candidate cannot activate until every authority prepared the shared digest;
  rejection and stale completion preserve the last-known-good profile.
