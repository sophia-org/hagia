...
proc profileName*(action: PolicyAction): string =
  ...
  of PolicyAction.sessionRestartWm:
    "restart-wm"
  of PolicyAction.sessionApplicationLauncher:
  ...
  of PolicyAction.selectDwindleLayout:
    "layout-dwindle"
  of PolicyAction.splitDirectionLeft:
    "split-left"
  of PolicyAction.splitDirectionRight:
    "split-right"
  of PolicyAction.splitDirectionUp:
    "split-up"
...
proc sessionOperationSlot*(action: PolicyAction): uint16 =
  ...
  of PolicyAction.sessionApplicationLauncher: 7
  else: 0
...
proc applyAction*(model: var PolicyModel, output: OutputId, action: PolicyAction) =
  ...
  of PolicyAction.sessionTerminal .. PolicyAction.sessionLogout,
      ...
      PolicyAction.sessionApplicationLauncher:
  ...
  of PolicyAction.splitDirectionRight:
    model.tabTreeCommand(output, TabTreeCommand.splitRight)
  of PolicyAction.splitDirectionUp:
