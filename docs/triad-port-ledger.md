...
| Behavior family | State | Port requirement |
| --- | --- | --- |
| Overview and workspace previews | WM-owned candidate, h002 | Layout, navigation and selection now use Sophia's negotiated generic presentation/input contract. Paired acceptance is t241; hot corners, drag and animation behavior are outside this feature's scope. The earlier shell allocation is superseded by the [overview plan](notes/plans/64ac6jf6-workspace-overview-across-hagia-narthex-and-sophia.md). |
